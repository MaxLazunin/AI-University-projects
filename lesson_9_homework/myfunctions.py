...
print(list(my_filter([1, 2, 3, 4, 5], lambda x: x > 3)) == [4, 5])  # True
print(list(my_filter([1, 2, 3, 4, 5], lambda x: x == 2)) == [2])  # True
print(list(my_filter([1, 2, 3, 4, 5], lambda x: x != 3)) == [1, 2, 4, 5])  # True
print(list(my_filter(['a', 'b', 'c', 'd'], lambda x: x in 'abba')) == ['a','b'])  # True
